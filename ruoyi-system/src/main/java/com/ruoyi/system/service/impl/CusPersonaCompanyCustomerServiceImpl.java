...
import com.ruoyi.system.mapper.CusPersonaCompanyCustomerMapper;
import com.ruoyi.system.service.ICusPersonaCompanyCustomerService;
...
public class CusPersonaCompanyCustomerServiceImpl implements ICusPersonaCompanyCustomerService
{
    ...
    public void addCompanyCustomerByTyc(CustomerBusinessVo customerBusinessVo, String userName) {
        ...
        while (!endLoop) {
            pageNum++;
            String suffix = "customer/2.0?pageSize=20&pageNum=" + pageNum + "&id=" + companyId;
            try {
